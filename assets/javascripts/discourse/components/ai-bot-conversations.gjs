    ...
    <div class="ai-bot-conversations">
      ...
      <div class="ai-bot-conversations__content-wrapper">
        ...
        <div class="ai-bot-conversations__input-wrapper">
          <DButton
            @icon="{{this.siteSettings.ai_kuaza_upload_iconu ? this.siteSettings.ai_kuaza_upload_iconu : 'upload'}}"
          ...
          <DButton
            ...
            @icon="{{this.siteSettings.ai_kuaza_gonderme_iconu ? this.siteSettings.ai_kuaza_gonderme_iconu : 'paper-plane'}}"
